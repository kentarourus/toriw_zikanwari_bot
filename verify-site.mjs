...
for(const page of ['dist/classes/1-5/index.html','dist/classes/2-1/index.html','dist/classes/2-3/index.html','dist/classes/2-5/index.html'])assert.doesNotMatch(fs.readFileSync(page,'utf8'),/hostname\.endsWith/,'Class page contains an obsolete redirect');
for(const page of ['dist/classes/1-5/index.html','dist/classes/2-1/index.html','dist/classes/2-3/index.html','dist/classes/2-5/index.html'])assert.match(fs.readFileSync(page,'utf8'),/manifest\.webmanifest/,'PWA manifest is missing from a class page');
for(const page of ['dist/classes/1-5/index.html','dist/classes/2-1/index.html','dist/classes/2-3/index.html','dist/classes/2-5/index.html'])assert.match(fs.readFileSync(page,'utf8'),/id="source-link"/,'Class page is missing the source spreadsheet in related links');
